...
const aeoSaasTools: AeoTool[] = [
  ...
  },
  {
    ...
    nameEn: 'Scrunch AI',
    description:
      'Prompt 级别 AEO 监测工具，覆盖 8 大 AI 引擎，支持情感标记、错误信息检测和页面级审计，帮助品牌精细化管理 AI 搜索中的品牌叙事。',
    url: 'https://scrunch.ai',
    tags: ['AEO', 'Prompt级监测', '8引擎', '情感标记', '错误信息', '页面审计'],
    isFree: false,
    hasFreeplan: false,
    isOpenSource: false,
    hasApi: true,
    pricing: '$100/mo 起',
    highlights: ['8 大 AI 引擎全覆盖监测', '情感 + 错误信息双维度标记', 'Prompt 级精细化页面审计'],
  },
  {
    id: 'otterly-ai',
    name: 'Otterly.AI',
...
const aeoEnterpriseTools: AeoTool[] = [
  ...
  },
  {
    ...
    url: 'https://semrush.com/ai-visibility',
...
const aeoContentTools: AeoTool[] = [
  ...
  },
  {
    ...
    nameEn: 'SEMAI.AI',
    description:
      '专注 AEO 的内容差距检测与 AI 就绪内容生成平台，分析网站内容与 AI 引擎期望的差距，提供针对性优化建议和内容模板，帮助品牌快速提升 AI 可见度。',
    url: 'https://semai.ai',
    tags: ['AEO', '内容差距', 'AI就绪', '内容生成', '专项优化'],
    isFree: false,
    hasFreeplan: false,
    isOpenSource: false,
    hasApi: false,
    pricing: '联系报价',
    highlights: ['专注 AEO 内容差距检测', 'AI 就绪内容生成，快速提升可见度', '针对性优化建议 + 内容模板'],
  },
  {
    id: 'inlinks',
    name: 'InLinks',
...
const aeoChinaTools: AeoTool[] = [
  ...
  },
  {
    ...
    nameEn: 'GEOWISE',
    description:
      '新榜旗下 GEO/AEO 监测与分发平台，覆盖 12 款主流 AI 平台，将内容创作、分发和 AEO 监测整合为一体，借助新榜强大的内容生态资源提供全链路优化服务。',
    url: 'https://www.xinbang.com',
    tags: ['AEO', 'GEO', '新榜', '内容分发', '12款AI平台', '内容监测'],
    isFree: false,
    hasFreeplan: false,
    isOpenSource: false,
    hasApi: true,
    highlights: ['新榜旗下，内容生态资源丰富', '内容 + 分发 + AEO 监测全链路', '覆盖 12 款主流 AI 平台'],
  },
  {
    id: 'sheepgeo',
    name: 'SheepGeo',
  ...
  },
  {
    ...
    nameEn: 'Laver AI',
    description:
      '国内 AI 可见度监测与优化闭环平台，覆盖 ChatGPT、DeepSeek、Kimi、豆包、通义千问 5 大主流 AI 平台，从监测到优化形成完整闭环，操作简单易上手。',
    url: 'https://zicaiai.com',
    tags: ['AEO', 'GEO', '监测+优化闭环', 'ChatGPT', 'DeepSeek', 'Kimi', '5大平台'],
    isFree: false,
    hasFreeplan: true,
    isOpenSource: false,
    hasApi: false,
    highlights: ['监测 + 优化闭环，一站式服务', '覆盖 ChatGPT / DS / Kimi / 豆包 / 千问', '操作简单，快速上手'],
  },
  {
    id: 'suproai',
    name: '数珀 AI',
