  ...
  tools: [
   {
    ...
    desc: 'paste a site URL, fetch and generate llms.txt in one click, supports online hosting and auto-updates',
    badge: 'Recommended',
    badgeColor: '#6366F1',
   },
  ],
 ...
 <div class="llms-page">
  ...
  <div class="llms-hero">
   ...
   <div class="llms-hero-content">
    ...
    <p class="llms-hero-sub">
     Like <strong>robots.txt</strong>, but built for <strong>large AI models</strong> — it tells ChatGPT, Perplexity and Gemini what your site offers. Proposed by <strong>Jeremy Howard (fast.ai)</strong> in 2024, it has become a core GEO/AEO infrastructure standard.
    </p>
    ...
    <div class="llms-concept-bar">
     ...
     <div class="llms-ci">
      <VaIcon name="smart_toy" size="14px" color="#A78BFA" /><span><strong>GEO/AEO</strong> infrastructure essential</span>
     </div>
     <span class="llms-sep">·</span>
     <div class="llms-ci">
  ...
  <div v-if="activeTab === 'templates'" class="llms-tpl-body">
   <p class="llms-tpl-intro">
    ...
    llms.txt templates by industry, click to copy, then paste into any editor to edit, then upload it to your site root
   </p>
   ...
   <div class="llms-tpl-tip">
    ...
    <div>
     ...
     <ol>
      <li>Click"Copy template"copy the content to your clipboard</li>
      <li>paste into any text editor, edit the site name, links and descriptions to match your site</li>
      <li>Save the file as <code>llms.txt</code>, upload to your site root</li>
      <li>visit <code>https://yoursite.com/llms.txt</code> verify it’s accessible</li>
      <li>Open"Recommended tools"→"Submit & indexing platforms"submit for indexing</li>
     </ol>
    </div>
   </div>
  </div>
  ...
  <div v-if="activeTab === 'guide'" class="llms-guide-body">
   <div class="llms-guide-grid">
    ...
    <div class="llms-gc llms-gc--wide">
     ...
     <p>
      <code>llms.txt</code> is a plain-text file in your site root, designed specifically for large AI models——tells
      LLM"<strong>what this site is about, which pages are worth reading, and how to understand it</strong>". 
     </p>
     <p>
      by <strong>Jeremy Howard (fast.ai founder)</strong> proposed in 2024, analogy
      <code>robots.txt</code> for search engine crawlers, <code>llms.txt</code> is a semantic index for AI models. Currently
      Cloudflare, Anthropic, Perplexity and other ecosystem tools can read it. 
     </p>
    </div>
...
- [Blog](https://example.com/blog): articles</pre
     >
     <p class="llms-note">Minimal format: Markdown + link list, LLM so LLMs can read your site structure at a glance</p>
    </div>
     ...
     <ul class="llms-best">
      <li>
       <VaIcon name="check_circle" size="13px" color="#10B981" /><span
        ><strong>Make the one-line description precise</strong>: include business type + target users + core value</span
       >
      </li>
      <li>
       <VaIcon name="check_circle" size="13px" color="#10B981" /><span
        ><strong>Make link descriptions specific</strong>: avoid"Read more", clearly describe the page content</span
       >
      </li>
      <li>
       <VaIcon name="check_circle" size="13px" color="#10B981" /><span
        ><strong>Use Optional to set priority</strong>: core content first, put secondary content in Optional</span
       >
      </li>
      <li>
       <VaIcon name="check_circle" size="13px" color="#10B981" /><span
      ...
      <li>
       <VaIcon name="check_circle" size="13px" color="#10B981" /><span
        ><strong>Update regularly</strong>: update it after any major site redesign llms.txt</span
       >
      </li>
     </ul>
    </div>
    ...
    <div class="llms-gc">
     ...
     <ol class="llms-steps">
      <li>
       <span class="llms-step-n">1</span><span>use the template library, write or copy one that fits your <code>llms.txt</code> Content</span>
      </li>
      <li>
       <span class="llms-step-n">2</span><span>Upload the file to your site root (next to <code>robots.txt</code> same level)</span>
      </li>
      <li>
    ...
    <div class="llms-gc llms-gc--wide">
     ...
     <div class="llms-cmp-table">
      ...
      <div class="llms-cmp-row"><span>Audience</span><span>search engine crawlers</span><span>AI large models (LLM)</span></div>
      <div class="llms-cmp-row"><span>Core features</span><span>controls crawl permissions</span><span>provides semantic understanding</span></div>
